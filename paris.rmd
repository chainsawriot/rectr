...
get_headline <- function(paris_gmm) {
    map_dfr(seq_len(ncol(paris_gmm$theta)), get_sample, paris_gmm$dfm$corpus, theta = paris_gmm$theta) %>% unique %>% print(n = 100)
}

set.seed(42)
get_headline(paris_gmm)
```
